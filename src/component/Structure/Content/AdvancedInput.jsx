...
const AdvancedInput = () => {
  ...
  return (
    <div>
      <div className="title">Advanced Input Implementation</div>
      <div>
        This is how you can use a rich text editor in your project. You can pass{" "}
        <b>AdvancedInput</b> prop to the library component to enable this mode.
        <br />
        These can be pretty useful for blogging websites that need to have
        detailed conversations.
      </div>
      <br />
      <div>
        <b>Live Implementation of the below example( Try it out yourself!! )</b>
        <CommentSection
          currentUser={{
            currentUserId: "01a",
            currentUserImg:
